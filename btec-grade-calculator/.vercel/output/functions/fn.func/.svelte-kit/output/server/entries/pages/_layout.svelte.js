import { s as setContext, c as create_ssr_component, e as escape, a as add_attribute, b as compute_slots, d as subscribe, f as createEventDispatcher, g as spread, h as escape_object, v as validate_component, m as missing_component, i as getContext } from "../../chunks/ssr.js";
...
const Layout = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  $$unsubscribe_page();
  return `${$$result.head += `<!-- HEAD_svelte-4g7a7e_START --><meta name="robots" content="index, follow"><meta property="og:site_name" content="BTEC Grade Calculator"><meta property="og:type" content="website"><meta property="og:url"${add_attribute("content", canonicalUrl, 0)}><meta name="twitter:card" content="summary"><link rel="canonical"${add_attribute("href", canonicalUrl, 0)}><!-- HEAD_svelte-4g7a7e_END -->`, ""} <div class="relative min-h-screen overflow-hidden bg-[#060816] text-white"><div class="pointer-events-none absolute -left-40 -top-56 h-[30rem] w-[30rem] rounded-full bg-cyan-500/20 blur-3xl"></div> <div class="pointer-events-none absolute -right-40 -top-24 h-[26rem] w-[26rem] rounded-full bg-fuchsia-500/20 blur-3xl"></div> <div class="pointer-events-none absolute left-1/3 top-2/3 h-[20rem] w-[20rem] rounded-full bg-violet-500/20 blur-3xl"></div> ${validate_component(Modal, "Modal").$$render($$result, {}, {}, {})} ${validate_component(AppBar, "AppBar").$$render(
    $$result,
    {
    ...
    {
      trail: () => {
        return `<div class="flex items-center gap-2 md:gap-3" data-svelte-h="svelte-hg7zvy"><a class="btn btn-sm variant-soft-surface" href="https://github.com/Brown-Dan" target="_blank">GitHub</a> <a class="btn btn-sm variant-soft-surface" href="https://www.linkedin.com/in/daniel-brown-29bb19292/?originalSubdomain=uk" target="_blank">LinkedIn</a></div> `;
      },
      default: () => {
        return `<h1 class="text-base md:text-lg font-semibold tracking-wide" data-svelte-h="svelte-1izg0dl">BTEC Grade Calculator</h1> `;
      },
      lead: () => {
        return `<div class="flex gap-2"><button type="button" class="btn btn-sm variant-soft-surface" data-svelte-h="svelte-1rfha73">Back</button> <button type="button" class="btn btn-sm variant-soft-surface" data-svelte-h="svelte-1ikf15h">Home</button></div>`;
      }
    }
  )} <main class="relative z-10 max-w-7xl mx-auto">${slots.default ? slots.default({}) : ``}</main></div>`;
});
export {
  Layout as default
};

var Grade = /* @__PURE__ */ ((Grade2) => {
  Grade2["UNCLASSIFIED"] = "U";
  Grade2["NEAR_PASS"] = "NP";
  Grade2["PASS"] = "P";
  Grade2["MERIT"] = "M";
  Grade2["DISTINCTION"] = "D";
  Grade2["DISTINCTION_STAR"] = "D*";
  return Grade2;
})(Grade || {});
const CERTIFICATE_POINTS_TO_GRADE = /* @__PURE__ */ new Map([
...
const EXTENDED_CERTIFICATE_POINTS_TO_GRADE = /* @__PURE__ */ new Map([
  [0, [Grade.UNCLASSIFIED]],
  [36, [Grade.PASS]],
  [52, [Grade.MERIT]],
...
const FOUNDATION_DIPLOMA_POINTS_TO_GRADE = /* @__PURE__ */ new Map([
  [0, [Grade.UNCLASSIFIED]],
  [51, [Grade.PASS]],
  [73, [Grade.MERIT]],
...
const DIPLOMA_POINTS_TO_GRADE = /* @__PURE__ */ new Map([
  [0, [Grade.UNCLASSIFIED]],
...
const EXTENDED_DIPLOMA_POINTS_GRADE = /* @__PURE__ */ new Map([
  [0, [Grade.UNCLASSIFIED]],
...
const COURSE_TYPE_TO_POINTS_TO_GRADE = /* @__PURE__ */ new Map([
...
function getPointsToGradeMap(courseType) {
  return COURSE_TYPE_TO_POINTS_TO_GRADE.get(courseType);
}
export {
  getPointsToGradeMap as g
};

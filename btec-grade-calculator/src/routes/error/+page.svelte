<div class="flex justify-center overflow-scroll mt-5">
    <div class="p-8 rounded-lg shadow-2xl m-5">
        <div class="text-center mb-6">
            <h1 class="text-4xl font-bold text-white h1 p-5">Oops! We're Sorry...</h1>
        ...
        <div class="text-center p-5">
            ...
            <p class="text-lg mt-6 font-extrabold">Thanks for your patience and understanding!</p>
        </div>
    </div>
</div>
